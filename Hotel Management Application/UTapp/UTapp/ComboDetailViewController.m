...
- (void)viewDidLoad {
    app1=(AppDelegate *)[[UIApplication sharedApplication]delegate];
     ...
     NSString *str=[[NSString alloc]initWithFormat:@"select smName,smImg,smQty,smPrice,pkSMid from SMenu where fkMid=1"];
    ...
    //self.imgTiffin.image=[dicTiffin objectForKey:@"smImg"[UIImage imageNamed:@"smImg"]];i
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ComboDetailTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:@"mycell"];
    if (cell!=nil) {
        cell=[[ComboDetailTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"mycell"];
    }
    ...
    UILabel  *name1= [[UILabel alloc]initWithFrame:CGRectMake(116, 5, 160, 40)];
    ...
    UILabel  *nameprise= [[UILabel alloc]initWithFrame:CGRectMake(116, 25, 40, 40)];
   ...
   /* UIButton  *btn= [[UIButton alloc]initWithFrame:CGRectMake(220, 100, 110, 40)];
...
/*-(void)btnClick:(UIButton *)sender
{
    ...
    NSString *str=[[NSString alloc]initWithFormat:@"insert into food_order values('%ld','%@','%@','%@')",(long)OID,app1.strEmail,FID,lblQ.text];
