//
//  IndianBreadSetMealMenuViewController.m
//  UTapp
//
...
#import "RotiTableViewCell.h"
#import "MyBasketViewController.h"

//select ssmName,ssmImg,ssmQty,ssmPrice,ssMid from SSMenu where fkSMid=23;

@interface IndianBreadSetMealMenuViewController ()

@end

@implementation IndianBreadSetMealMenuViewController
...
- (void)viewDidLoad {
    ...
    NSString *str=[[NSString alloc]initWithFormat:@"select smName,smImg,smQty,smPrice,pkSMid from SMenu where fkMid=111"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    RotiTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:@"mycell"];
    if (cell!=nil) {
        cell=[[RotiTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"mycell"];
    }
