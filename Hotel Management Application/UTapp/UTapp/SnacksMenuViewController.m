...
@interface SnacksMenuViewController ()

@end

@implementation SnacksMenuViewController
//search bar mate nu
@synthesize SearchData,sbar,mytableview, tableContent,searchSnack;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell!=nil) {
        cell=[[menuTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"mycell"];
    }
