...
@interface SweetsMenuViewController ()

@end

@implementation SweetsMenuViewController

@synthesize SearchData,sbar,mytableview, tableContent;
...
- (void)viewDidLoad {
    ...
    NSString *str=[[NSString alloc]initWithFormat:@"select smName,smImg,smQty,smPrice,pkSMid from SMenu where fkMid=4"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SweetTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:@"mycell"];
    if (cell!=nil) {
        cell=[[SweetTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"mycell"];
    }
