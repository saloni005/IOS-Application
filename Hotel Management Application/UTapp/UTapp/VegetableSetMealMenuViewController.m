//
//  VegetableSetMealMenuViewController.m
//  UTapp
//
...
#import "VegetableSetMealMenuViewController.h"
#import "SetMealMenuViewController.h"
#import "Dataoperations.h"
#import "VegetableTableViewCell.h"
#import "MyBasketViewController.h"
#import "ComboViewController.h"

@interface VegetableSetMealMenuViewController ()

@end

@implementation VegetableSetMealMenuViewController
...
- (void)viewDidLoad {
    ...
    NSString *str=[[NSString alloc]initWithFormat:@"select smName,smImg,smQty,smPrice,pkSMid from SMenu where fkMid=222"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    VegetableTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:@"mycell"];
    if (cell!=nil) {
        cell=[[VegetableTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"mycell"];
    }
